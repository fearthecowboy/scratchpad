...
import { IpFlowProtocol } from "../enums/IpFlowProtocol";
...
export interface VerificationIPFlowParameters {
     ...
     * @Type  '2019-07-01' - type changed from 'Protocol | string' to 'IpFlowProtocol | string'
     */
    protocol?: IpFlowProtocol | string;
    /**
